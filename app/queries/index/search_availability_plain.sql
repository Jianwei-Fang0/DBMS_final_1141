-- app/queries/index/search_availability_explain.sql
-- 固定一組查詢參數，方便做 EXPLAIN (ANALYZE)
-- d = 2025-03-15, 18:00~20:00, 30 人，不指定館別 / 類型
...
WITH ctx AS (
  ...
  FROM (
    SELECT
      DATE '2025-03-15' AS d,
      TIME '18:00:00'   AS t1,
      TIME '20:00:00'   AS t2,
      30::int           AS ppl,
      NULL::int         AS building_id,
      NULL::text        AS vtype
  ) s
),

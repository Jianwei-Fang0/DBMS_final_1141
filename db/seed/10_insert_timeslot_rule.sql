...
-- 全館時段規則（平日 08-22，週末 09-22）


INSERT INTO timeslot_rule (venue_id, weekday, open_time, close_time, slot_minute)
SELECT v.venue_id, 1, '08:00', '22:00', 60
FROM venue v
JOIN building b ON v.building_id=b.building_id
WHERE v.name='共101' AND b.name='共同教學館';

INSERT INTO timeslot_rule (venue_id, weekday, open_time, close_time, slot_minute)
SELECT v.venue_id, 2, '08:00', '22:00', 60
FROM venue v
JOIN building b ON v.building_id=b.building_id
WHERE v.name='共101' AND b.name='共同教學館';

INSERT INTO timeslot_rule (venue_id, weekday, open_time, close_time, slot_minute)
SELECT v.venue_id, 3, '08:00', '22:00', 60
FROM venue v
JOIN building b ON v.building_id=b.building_id
WHERE v.name='共101' AND b.name='共同教學館';

INSERT INTO timeslot_rule (venue_id, weekday, open_time, close_time, slot_minute)
SELECT v.venue_id, 4, '08:00', '22:00', 60
FROM venue v
JOIN building b ON v.building_id=b.building_id
WHERE v.name='共101' AND b.name='共同教學館';

INSERT INTO timeslot_rule (venue_id, weekday, open_time, close_time, slot_minute)
SELECT v.venue_id, 5, '08:00', '22:00', 60
FROM venue v
JOIN building b ON v.building_id=b.building_id
WHERE v.name='共101' AND b.name='共同教學館';

INSERT INTO timeslot_rule (venue_id, weekday, open_time, close_time, slot_minute)
SELECT v.venue_id, 0, '09:00', '22:00', 60
FROM venue v
JOIN building b ON v.building_id=b.building_id
WHERE v.name='共101' AND b.name='共同教學館';

INSERT INTO timeslot_rule (venue_id, weekday, open_time, close_time, slot_minute)
SELECT v.venue_id, 6, '09:00', '22:00', 60
FROM venue v
JOIN building b ON v.building_id=b.building_id
WHERE v.name='共101' AND b.name='共同教學館';
...
FROM venue v
JOIN building b ON v.building_id=b.building_id
WHERE v.name='一樓中央大廳 展覽牆柱區' AND b.name='博雅教學館藝文空間';
...
FROM venue v
JOIN building b ON v.building_id=b.building_id
WHERE v.name='一樓西側大廳 桌椅區 (101 教室旁)' AND b.name='博雅教學館藝文空間';
...
FROM venue v
JOIN building b ON v.building_id=b.building_id
WHERE v.name='一樓西側大廳 圖書攤位區 (入口處)' AND b.name='博雅教學館藝文空間';
...
FROM venue v
JOIN building b ON v.building_id=b.building_id
WHERE v.name='中央大廳圓桌區' AND b.name='博雅教學館藝文空間';
